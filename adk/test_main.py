...
async def run_pipeline(step_name: str, prompt: str):
    ...
    try:
        ...
        print(
            f"❌ Error: Module '{module_path}' loaded, but no 'root_agent' export was found."
        )
        return
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Master Execution Pipeline for ADK Bootcamp Layers."
    )
    parser.add_argument(
        "--step",
        type=str,
    ...
    parser.add_argument(
        "--prompt",
        type=str,
        default="Show me what raw turnstile files we have.",
