        ...
        if issues is not None:
            ...
            for issue in issues:                                
                ...
                if generated_code is not None:            
                    ...
                    comment_posted = GitHubService.post_issue_comment(repo,  issue.number, comment, access_token=github_token)
...
# python3 gen_code_from_issue.py --repo ozkary/ai-engineering --tag user-story
