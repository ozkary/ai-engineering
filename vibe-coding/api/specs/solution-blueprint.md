...
- **`specs/specs-devops.md`** (Automation & Deployment): Outlines the DevOps process. Specifies environmental configurations (FUNCTION_NAME, ENTRY_POINT, REGION), the step-by-step shell build isolation pipeline (/dist purge and compile), and the gcloud Gen2 script layout.
